...
Outcome data sources for the Get REAL! program include the *Girl Survey*, *Parent Survey*, *Teacher Survey* and *Academic Data for Q1, Q2, Q3, Q4* 

The girl survey was designed to measure a students skills in healthy releationships, academic mastery, and academic engagement. The parent and teacher surveys were designed to cross validate the results of the girl survey.  
...
30. **iamMotivatedToGraduateHighSchool:** variable measures motivation to complete high school 

31. **iReadBooksforFun:** varialbe measures student's attitude towards reading.

32. **ireallyLikeWhoIam:** varialbe measures self worth.

33. **.....ImproveMySkillsThisYear:** varialbe measures motivation to improve skills
...
8. **hr.stddev** The standard deviation of the score obtained from the healthy relationship questions. 
...
14. **ae.stddev** The standard deviation of the score obtained from the academic engagement questions.
...
19. **girlCode** The unique identification number for students participating the program.
...
22. **graduate** This question inquires from the parent if they believe the student is motivated to graduate high school.
...
28. **helpedMyDaughterGainConfidenceInHerAbilities** This is an attributional Question that assess from the parent if the student gained confidence in her abilities from the Get REAL! program.
...
29. **helpedMyDaughterAchieveSuccessInSchool** This is an attributional question that assess from the parent if they believe the Get REAL! program helped their daughter achieve success in school. 
...
30. **helpedEstablishPositiveRelationshipsWithHerClassmates** This is an attributional question that assess from the parent if they believe the Get REAL! program help their daughter establish positive relationships. 
